...
$pdf -> SetFont('Times','',16);
    ...
    // en tête 
        ...
        $liste = $enseignant ->afficherEnseignant();
        ...
        $pdf -> Ln(15);
        $pdf -> Cell(250,10,'LISTE DES ENSEIGNANTS',0,0,'C');
        ...
        $pdf -> Cell(80,10,utf8_decode('Matieres'),1,0,'');
        $pdf ->Ln();
        ...
        foreach ($liste as $key => $value) {
           ...
           $pdf -> Cell(35,10,$value->telephone,1);
           $pdf -> Cell(80,10,utf8_encode($value->matieres),1,1,'C');
